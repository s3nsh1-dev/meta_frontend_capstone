...
const Profile = () => {
  ...
  const handleViewType = () => {
    return viewOption === "reservations" ? (
      <ProfileReservations />
    ) : currentProfile[viewOption].length === 0 ? (
      <>
        <ShowEmptyForProfile viewOption={viewOption} />
      </>
    ) : (
      <>
        <ShowCartOrOrder
        ...
        />
        {viewOption === "cart" ? (
          <CartTotal Cart={currentProfile["cart"]} />
        ) : null}
      </>
    );
  };
              ...
              <div className="profile-action-box">
                <div className="profile-action">
                  ...
                  <button
                    ...
                    onClick={() => {
                      updateProfileContext();
                      setViewOption("reservations");
                    }}
                  >
                    Reservations
                  </button>
                </div>
                <div>{handleViewType()}</div>
              </div>
            </div>
          </section>
          <div>
