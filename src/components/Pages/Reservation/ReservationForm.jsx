...
const ReservationForm = () => {
  ...
  const updateReservation = () => {
    ...
    const existingReservationDate = tempReservations["bookings"].find(
      (reservation) => reservation.date === booking.date
    );

    if (existingReservationDate) {
      const indexOfReservationDate = tempReservations["bookings"].findIndex(
        (reservation) => reservation === existingReservationDate
      );
    ...
    return (
      <div>
        <span className="empty-form-warning">
          !Please check and fill the field.
        </span>
      </div>
    );
  };
            ...
            <form className="reservation-form-box-container" action="">
              <div className="reservation-form-box">
                <div className="reservation-sub-box">
                  <label className="reservation-form-label" htmlFor="res-date">
                    Date
                  </label>
                  <input
                ...
                <div className="reservation-sub-box">
                  <label className="reservation-form-label" htmlFor="res-time">
                    Time
                  </label>
                  <select
                    className="reservation-form-input"
                ...
                <div className="reservation-sub-box">
                  ...
                  <input
                    ...
                    max="10"
                    onChange={(e) =>
                      handleSelectedType(e.target.value, "guest")
                    }
                  />
                  {isFormEmpty === true ? renderEmptyWarning() : null}
                </div>
                <div className="reservation-sub-box">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleSelectedType(e.target.value, "occasion")
                    }
                  >
